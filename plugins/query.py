...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/TeluguBadi_Ofcl")
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('❣️ SUPPORT CHANNEL ❣️', callback_data='source')
            ],[
            InlineKeyboardButton('🏠 𝙷𝙾𝙼𝙴 🏠', callback_data='start'),
            InlineKeyboardButton('🔐 𝙲𝙻𝙾𝚂𝙴 🔐', callback_data='close_data')
        ]]
        ...
        buttons = [[
            InlineKeyboardButton('UPDATES', url='https://t.me/TeluguBadi_Ofcl')
            ],[
